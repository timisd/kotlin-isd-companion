...
@Composable
fun DecimalToBinaryScreen() {
    val navigator = LocalNavigator.currentOrThrow
    var showSolution by remember { mutableStateOf(false) }
    var decimalNumber by remember { mutableStateOf(generateRandomDecimal()) }

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(Strings.get("decimal_to_binary", currentLanguage)) },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = Strings.get("convert_decimal_to_binary", currentLanguage),
            ...
            Card(
                ...
                Column(
                    ...
                    if (showSolution) {
                        Text(
                            text = "${Strings.get("binary_value", currentLanguage)}: ${
            ...
            Row(
                ...
                Button(
                    onClick = {
                        decimalNumber = generateRandomDecimal()
                        showSolution = false
                    }
                ) {
                    Icon(
...
private fun generateRandomDecimal(): Int {
